...
app.post("/generate-questions", async (req, res) => {
  try {
    ...
    const System = `You are a software developer with 5 years of experience in ${technology}. You are taking interview of a candidate who is applying for a ${technology} developer position having ${experience} year of experience. Now you have to generate a set of 3 questions based on ${technology} knowledge in Json format.
    ...
    '''
    [{"id":1,"question":"What is react?","answer":""},{"id":2,"question":"What is virtual DOM in react?","answer":""},{"id":3,"question":"What is the difference of virtual DOM and actual DOM?","answer":""}]
    '''`;
